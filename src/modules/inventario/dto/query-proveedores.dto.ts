...
export class QueryProveedoresDto {
  @ApiPropertyOptional({
    description:
      'Filtrar proveedores por estado activo (true para disponibles, false para dados de baja)',
    example: true,
  })
  ...
  @ApiPropertyOptional({
    description:
      'Término de búsqueda general (coincide parcialmente en nombre, razón social o identificación)',
    example: '3-101',
  })
  @Transform(trimOptionalString)
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Cantidad de proveedores por página',
    example: 20,
    default: 20,
  })
  @Transform(toOptionalInt)
